...
{
    public static void ForGizmo(Vector3 pos, Vector3 direction, float arrowHeadLength = 0.1f, float arrowHeadAngle = 20.0f)
    {
    ...
    public static void ForDebug(Vector3 pos, Vector3 direction, float arrowHeadLength = 0.1f, float arrowHeadAngle = 20.0f)
    {
