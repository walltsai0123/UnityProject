...
namespace XPBD.GPU
{
    ...
    public class SoftBodySystemGPU : MonoBehaviour
    {
        ...
        {
            if (VerticesNum == 0 || TetsNum == 0) return;
            softbodyCS.SetFloat("dt", (float)dt);
        ...
        private void InitComputeBuffers()
        {
            ...
            particleBuffer = ComputeHelper.CreateStructuredBuffer<SoftBodyParticle>(VerticesNum);
            ...
            ComputeHelper.SetBuffer(softbodyCS, particleBuffer, "particles", preSolveKernel, solveElementKernel, postSolveKernel, 3, 4);
